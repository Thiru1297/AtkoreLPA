...
import { AlertCircle, TrendingUp, Filter, Download, LayoutDashboard, ListTodo, Search, X } from 'lucide-react';
...
export function DepartmentOwnerDashboard({ onNavigate, onExit }: DepartmentOwnerDashboardProps) {
  ...
  const actionsByStatus = [
    { name: 'Open', value: 5, color: '#F7630C' },
    { name: 'In Progress', value: 8, color: '#4CAC48' },
    { name: 'Overdue', value: 5, color: '#D13438' },
    { name: 'Closed', value: 3, color: '#6B7280' },
  ];

  const urgentActions = [
    { id: 'ACT-2025-045', audit: 'AUD-2025-003', description: 'Missing work instruction at Station 3', auditorName: 'John Smith', dueDate: '2025-11-26', status: 'overdue', department: 'Production Line 1', priority: 'high' },
    { id: 'ACT-2025-046', audit: 'AUD-2025-005', description: 'Incomplete PPE storage labeling', auditorName: 'Emily Chen', dueDate: '2025-11-24', status: 'overdue', department: 'Safety', priority: 'high' },
    { id: 'ACT-2025-047', audit: 'AUD-2025-006', description: 'Outdated SOP posted in break room', auditorName: 'David Brown', dueDate: '2025-11-25', status: 'overdue', department: 'Administration', priority: 'medium' },
    { id: 'ACT-2025-048', audit: 'AUD-2025-007', description: 'Calibration certificate expired for gauge #125', auditorName: 'Jane Doe', dueDate: '2025-11-29', status: 'open', department: 'Quality Control', priority: 'medium' },
    { id: 'ACT-2025-049', audit: 'AUD-2025-008', description: 'Fire extinguisher inspection tag missing', auditorName: 'Robert Taylor', dueDate: '2025-11-27', status: 'overdue', department: 'Facilities', priority: 'high' },
    { id: 'ACT-2025-050', audit: 'AUD-2025-009', description: 'Material handling cart wheels need replacement', auditorName: 'Lisa Anderson', dueDate: '2025-11-28', status: 'overdue', department: 'Logistics', priority: 'medium' },
    { id: 'ACT-2025-051', audit: 'AUD-2025-010', description: 'Safety guard damaged on press machine', auditorName: 'Mike Johnson', dueDate: '2025-11-30', status: 'in-progress', department: 'Maintenance', priority: 'high' },
    { id: 'ACT-2025-052', audit: 'AUD-2025-012', description: 'Update 5S board with latest standards', auditorName: 'Sarah Williams', dueDate: '2025-11-18', status: 'closed', department: 'Warehouse', priority: 'low' },
  ];
  
  // Get unique audits for filter
  const uniqueAudits = Array.from(new Set(urgentActions.map(a => a.audit)));
  ...
  const getDisplayedActions = () => {
    if (activeTab === 'overview') {
      return urgentActions.filter(action => action.status === 'overdue');
    }
  ...
  const activeFilterCount = (filterStatus !== 'all' ? 1 : 0) + (filterAudit !== 'all' ? 1 : 0);
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-text-secondary">
                    You have 5 overdue actions that require immediate attention.
                  </p>
                </div>
