...
import { ChevronLeft, Calendar, User, MapPin, Clock, Camera, Bell, CheckCircle, XCircle, MinusCircle, ChevronDown, ChevronUp } from 'lucide-react';
...
export function AuditDetailPage({ auditId, onBack, onExit, onNavigateToAction }: AuditDetailPageProps) {
        ...
        <Card>
          <div className="space-y-5">
            <div className="flex items-start justify-between gap-4">
              ...
              <Badge variant="accepted">{auditData.status}</Badge>
            </div>
